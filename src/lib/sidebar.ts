import type { StarlightSidebarConfig, StarlightSidebarItem } from "../starlight-types.js";
...
export function sidebarSlugOrder(sidebar: StarlightSidebarConfig | undefined): string[] {
  const out: string[] = [];
